...
class Node:
    def __init__(self, parent_id, new_state, direction):
    ...
    def create_new_node(self, new_snake_loc, new_seeds_score, direction):
        ...
        if hashed_new_state in set_of_states:
            ...
            new_node = Node(self.id, new_state, direction)
            return new_node
...
start_bfs()
finish = time.time()
print("BFS finished in : %f milli-seconds" % ((finish - start) * 1000))
